...
$(document).scroll(function () {
    ...
    if (y > 1300) {
        $('.bottomMaxMenu').fadeIn();
    } else {
        $('.bottomMaxMenu').fadeOut();
    }
...
// Open picture in popup

$(".play_popup_picture").click(function(event){
	event.preventDefault();
	var pictureToShow = $(this).attr("href");
	$(".picture_popup .iframe_container").html('<img src="'+pictureToShow+'"/>');
	$(".picture_popup, .overlay").fadeIn(300);
});

// Close picture popup

$(".picture_popup .close, .overlay").click(function(e){
	$(".picture_popup, .overlay").fadeOut(300);
	setTimeout(function() {
		$(".picture_popup .iframe_container").html('');
	},300);
});
 
$(".picture_popup .iframe_container, .overlay").click(function(e){
	$(".picture_popup, .overlay").fadeOut(300);
	setTimeout(function() {
		$(".picture_popup .iframe_container").html('');
	},300);
